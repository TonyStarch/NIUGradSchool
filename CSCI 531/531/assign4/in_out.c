...
*
* Description: 
* This file contains the implementation for I/O routines
* which are taken from UNIX Network Programming by Stevens,
* Fenner, and Rudoff. As such, these functions are minimally 
