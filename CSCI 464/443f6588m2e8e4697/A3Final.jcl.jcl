...
* DESCRIPTION:
*
* This assignment contains routines used for implementing a 
* queue. Thes routines are QINSERT, QDELETE, QFRONT, QFULL, and
* QEMPTY. These routines are called by a driver program by the name
* of QDriver. The routines implement a queue by using two
* separate stacks, a "front" stack which uses linked allocation and
* a "rear" stack which uses sequential allocation.
*
********************************************************************
...
*  QINSERT
*
*  FUNCTION: To insert a new value into the rear of the queue if it
*            is not full. If it's full, return an error code.
*
*  INPUT: none
*
*  OUTPUT: none
...
*     0(R1) - This is a value to be put onto the stack (InValue)
*     4(R1) - This is to be used as a return value (RetValue)
*
*  EXIT CONDITIONS:
*
*     If the insertion was successful, RetValue is set to 0.
*     If the insertion wasn't successful, RetValue is set to 4. 
*
*  REGISTER USAGE:
*  
...
*  QDELETE
*
*  FUNCTION: Used to get the value at the front of the queue
*            and remove the value from the queue.
*
*  INPUT: none
*
*  OUTPUT: none
...
*  ENTRY CONDITIONS:
*
*  R1 points to a parameter list consisting of the following
*        0(R1) - "InValue", used to store value from the front
*                of the queue.
*        4(R1) - "RetValue", used to return an error code
*                if there was problems deleting from the queue
*  
*  EXIT CONDITIONS:
*
*       0(R1) - Contains value from the front of the queue if the
*               queue wasn't empty.
*       4(R1) - Contains 0 if delete was successful.
*               Contains 4 if queue was empty.
*
*  REGISTER USAGE:
*  R1 - @ OF PARM LIST
*  R6 - Holds address representing lower bound of the rear stack
*  R7 - Points to InValue    
*  R8 - Points to RetValue
*  R9 - Used for checking return code from QEmpty
*  R10 - Used as a base for pointing to top pointer
*        of front stack
*  LOGIC:
*  [1] Perform standard linkage and initialization
...
*  QFRONT
*
*  FUNCTION: If the queue is not empty, returns the value at the
*            front of the queue. If queue is empty, returns an
*            error code.
*
*  INPUT: none
*
...
*
*  R1 points to a parameter list which is described below:
*     0(R1) - Space to hold value from front of queue (InValue)
*     4(R1) - This is to be used as a return value (RetValue)
*
*  EXIT CONDITOINS:
*     0(R1) - Contains value from front of the queue if queue 
*             wasn't empty
*     4(R1) - Contains an error code indicating whether or not
...
*  R7 - points to InValue
*  R8 - points to RetValue
*  R9 - used to check the return code from QEmpty
*  R10 - used to address node at the top of the front stack
*
*  LOGIC:
*  [1] Perform standard linkage and initialization
*  [2] Get input parameters (InValue, RetValue)
...
*********************************
QMTRET   DS F            Returned value from QEmpty call
         EJECT
********************************************************************
*
*  QEMPTY
*
*  FUNCTION: This routine tests to see whether or not the Queue
*            is empty. Specific codes are set in RetValue depending
*            upon whether or not the Queue is empty.
*
*  INPUT: none
*
*  OUTPUT: none
...
*  ENTRY CONDITIONS:
*  R1 - @ OF PARM LIST
*        0(R1) - Typically this value is not used
*        4(R1) - Area for RetValue, which indicates whether or not
*                the queue was empty
*
*  EXIT CONDITIONS:
*        4(R1) set to 0 if queue is full, otherwise set to 4
*   
*  REGISTER USAGE:
*  R8 - Points to address of RetValue
*  R9 - Used to test the value of front stack top pointer
*
*  LOGIC:
*  [1] Perform standard linkage and initialization
...
*  QFULL         
*  
*  FUNCTION: Used to test whether or not the Queue is full.
*
*  INPUT: none
*
*  OUTPUT: none
*
*  ENTRY CONDITIONS:
*  R1 points to a parameter list which is as follows:
*      0(R1) - Parameter not used in this case
*      4(R1) - "RetValue", the return value used to indicate if
*              the queue is full or not.
*
*  EXIT CONDITONS:
*      4(R1) - Contains 0 if queue was full.
*              Contains 4 if queue was not full.
*
*  REGISTER USAGE:  
*  
*  R8 - Points to RetValue from parameter list
*  R9 - Used to hold rear stack top pointer.
*       Also used in setting value of RetValue.
* 
*  LOGIC:
*
*  [1] Perform standard linkage and initialization
